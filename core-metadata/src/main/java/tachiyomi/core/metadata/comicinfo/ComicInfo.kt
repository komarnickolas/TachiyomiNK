...
data class ComicInfo(
    ...
    // SY -->
    val padding: PaddingTachiyomiNK?,
    // SY <--
) {
    @XmlElement(false)
    ...
    // SY -->
    @Serializable
    @XmlSerialName("PaddingTachiyomiNK", "http://www.w3.org/2001/XMLSchema", "tysy")
    data class PaddingTachiyomiNK(@XmlValue(true) val value: String = "")
    // SY <--
}
